  ...
  <div class=" ">
    <main class="flex min-h-screen max-w-md pt-8 flex-col items-start py-8 md:max-w-2xl md:ml-28 md:pt-20" >
      ...
      <div class="flex flex-col gap-1 md:gap-2 z-10  text-gray-800 px-6 w-sm  items-start justify-between ">
        <div class="flex flex-wrap gap-1 md:flex md:gap-6 items-baseline   ">
        ...
        <div class="flex font-light flex-col gap-2 py-2 max-w-lg text-gray-600 text-sm mb-2 ">
          ...
          <p> Some of my interests are Creative development, Human-computer Interaction, Data science, Computational ethics, among others topics related humans and technology.</p>
        </div>
        <div class="flex flex-wrap md:flex-nowrap mt-2 ml-0 text-sm md:w-full items-center gap-2 md:mt-10">
          <a
